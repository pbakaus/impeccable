...
export const SUITES = {
  core: {
    ...
    triggers: [
      ...
      /^README(\.npm)?\.md$/,
      /^cli\/bin\//,
      /^tests\/(build|context|context-signals|critique-storage|design-parser|docs-integrity|impeccable-paths|skills-cli|target-args|test-suites|windows-path-fix)\.test\.(js|mjs)$/,
      /^tests\/lib\//,
    ],
    commands: [
      {
