...
export const VISUAL_EXAMPLES = {
  ...
  'low-contrast': `<div style="background: #000; padding: 16px 18px; font-family: system-ui, sans-serif;"><div style="color: #aaa; font-size: 16px;">Gray body text on black. WCAG 2 passes it, APCA catches the readability problem.</div></div>`,
