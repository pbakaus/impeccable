...
import tokens from './vendor/kinpaku-tokens.css' with { type: 'text' };
import kit from './vendor/kinpaku-kit.css' with { type: 'text' };
import rail from './vendor/docs-rail.css' with { type: 'text' };
