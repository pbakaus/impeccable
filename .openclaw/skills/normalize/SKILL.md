---
name: normalize
description: Use when you want to audits and realigns UI to match design system standards, spacing, tokens, and patterns. Use when the user mentions consistency, design drift, mismatched styles, tokens, or wants to bring a feature back in line with the system.
version: 1.0.0
permissions:
  filesystem: none
  network: false
