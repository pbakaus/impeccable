---
name: typeset
description: Use when you want to improves typography by fixing font choices, hierarchy, sizing, weight, and readability so text feels intentional. Use when the user mentions fonts, type, readability, text hierarchy, sizing looks off, or wants more polished, intentional typography.
version: 1.0.0
permissions:
  filesystem: none
  network: false
