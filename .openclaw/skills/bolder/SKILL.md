---
name: bolder
description: Use when you want to amplify safe or boring designs to make them more visually interesting and stimulating. Increases impact while maintaining usability. Use when the user says the design looks bland, generic, too safe, lacks personality, or wants more visual impact and character.
version: 1.0.0
permissions:
  filesystem: none
  network: false
