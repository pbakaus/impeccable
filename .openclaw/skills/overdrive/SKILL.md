---
name: overdrive
description: Use when you want to pushes interfaces past conventional limits with technically ambitious implementations — shaders, spring physics, scroll-driven reveals, 60fps animations. Use when the user wants to wow, impress, go all-out, or make something that feels extraordinary.
version: 1.0.0
permissions:
  filesystem: none
  network: false
