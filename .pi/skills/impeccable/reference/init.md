...
```bash
node .pi/skills/impeccable/scripts/questionnaire/init-questionnaire.mjs --prompt "<user prompt>"
```
...
```bash
node .pi/skills/impeccable/scripts/questionnaire/init-poll.mjs --session-id <sessionId>
```
