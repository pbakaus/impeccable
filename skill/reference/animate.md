...
Native (`ios` / `android` / `adaptive`): implementation follows the Motion section of the loaded platform reference (system transitions, OS Reduce Motion), never the web tooling below.
