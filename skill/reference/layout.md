...
Native (`ios` / `android` / `adaptive`): structure follows the Layout section of the loaded platform reference (platform navigation, insets, touch targets), never the CSS tooling below.
